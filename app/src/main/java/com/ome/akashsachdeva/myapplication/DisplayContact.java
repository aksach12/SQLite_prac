package com.ome.akashsachdeva.myapplication;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras !=null)
        {
            ...
            if(Value>0){
               ...
               // String phon = rs.getString(rs.getColumnIndex(MyDBHandler.COLUMN_PHONE));
                String emai = rs.getString(rs.getColumnIndex(MyDBHandler.COLUMN_EMAIL));
               // String stree = rs.getString(rs.getColumnIndex(MyDBHandler.CONTACTS_COLUMN_STREET));
                ...
                builder.setMessage(R.string.deleteItem)
                        .setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                Intent intent = new Intent(getApplicationContext(),com.ome.akashsachdeva.myapplication.MainActivity.class);
